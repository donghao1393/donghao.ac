...
2018 年冬天，我坐在阿布扎比的公寓里，面前摆着一台电烙铁、一管助焊剂，和一台花了近两千元买来的路由器——斐讯 K3。
...
1. **焊接**。K3 主板上有些硬件信息需要直接读取。我买了电烙铁和助焊剂，在网友的远程指导下，颤颤巍巍地完成了第一次硬件焊接。
2. **内核文档**。Linux 内核的设备树规范、Broadcom BCM5301X 系列的架构文档、ARM 平台下的 DTS 编写规范——一份一份地啃。
...
这个文件不长。但每一行都是对着一块实际电路板、用万用表量出来的。
